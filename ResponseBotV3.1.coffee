...
module.exports = (robot) ->
  ...
  robot.hear /(what vaur)/i, (msg) ->
    msg.send 'The current version of Responses that is loaded is V3.2'
  # ---
  # KB Responces
  # ---

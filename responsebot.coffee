...
module.exports = (robot) ->
  ...
  robot.hear /(kb autodl-irssi|kb autodl)/i, (msg) ->
  ...
  robot.hear /(kb public html|kb public folder|kb public_html)/i, (msg) ->
  ...
  robot.hear /(app lamp|app lamp stack)/i, (msg) ->
  ...
  robot.hear /(app ubuntu desktop|app vnc)/i, (msg) ->
  ...
  robot.hear /(app resilio|app resilio sync|app btsync)/i, (msg) ->
  ...
  robot.hear /(app mysql|app mariadb)/i, (msg) ->
  ...
  robot.hear /(app nginx|app php|app php7)/i, (msg) ->
  ...
  robot.hear /(appcat clients)/i, (msg) ->
  ...
  robot.hear /(actively refused|FTP cant connect|connection refused|ECONNREFUSED)/i, (msg) ->
  ...
  robot.hear /(ts ftp)/i, (msg) ->
    ...
    msg.send '4: Last and only option is try SFTP _(Type kb sftp for support)_, if this fails too then please contact an admin'
